...
class Rackcommands(): 
    ...
    def __init__(self,rack,rack_order,rack_position,rack_position_offset_x=0,rack_position_offset_y=0):
        self.rack=rack
...
# I think all the below can be removed - let's keep for now to keep the logic, will likely need to replace with our own calculations
